...
from config import ADMINS, LOG_CHANNEL, SUPPORT_CHAT, MELCOW_NEW_USERS
from Movies.database.chats import db
from Movies.database.media import Media
from Movies.utils import get_size, temp, get_settings
...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 UPDATES 📢', url='https://t.me/Trickyakash5213')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
